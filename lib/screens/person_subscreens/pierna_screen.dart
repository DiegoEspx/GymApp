...
import 'package:get/get.dart';
 ...
 class PiernaScreen extends StatefulWidget {
  const PiernaScreen({super.key});

  @override
  _PiernaScreenState createState() => _PiernaScreenState();
}

class _PiernaScreenState extends State<PiernaScreen> {
  final exercises = [
    {
      "title": "Sentadilla con barra",
      "description": "Fortalece cuádriceps, glúteos y core",
      "image": "assets/images/pierna3.webp"
    },
    {
      "title": "Zancadas",
      "description": "Mejora equilibrio y fortalece piernas",
      "image": "assets/images/pierna2.webp"
    },
    {
      "title": "Peso muerto rumano",
      "description": "Trabaja isquiotibiales y glúteos",
      "image": "assets/images/pierna1.jpeg"
    },
    {
      "title": "Prensa de piernas",
      "description": "Desarrolla fuerza en las piernas",
      "image": "assets/images/pierna4.jpg"
    }
