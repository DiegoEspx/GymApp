...
class PechoScreen extends StatefulWidget {
  const PechoScreen({super.key});

  @override
  _PechoScreenState createState() => _PechoScreenState();
}

class _PechoScreenState extends State<PechoScreen> {
  final exercises = [
    {
      "title": "Press de banca con barra",
      "description": "Desarrolla fuerza y volumen en el pecho",
      "image": "assets/images/pecho1.jpg"
    },
    {
      "title": "Aperturas con mancuernas",
      "description": "Define el pecho y mejora flexibilidad",
      "image": "assets/images/pecho2.png"
    },
    {
      "title": "Fondos en paralelas",
      "description": "Fortalece pecho, tríceps y hombros",
      "image": "assets/images/pecho3.webp"
    },
    {
      "title": "Press inclinado con mancuernas",
      "description": "Trabaja la parte superior del pecho",
      "image": "assets/images/pecho4.jpeg"
    }
