            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    setState(() {
                      _filterOption = 'day'; // Cambiar filtro a día
                    });
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    setState(() {
                      _filterOption = 'week'; // Cambiar filtro a semana
                    });
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    setState(() {
                      _filterOption = 'month'; // Cambiar filtro a mes
                    });
                  },
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children:
                            entry.value.map((routine) => Text('- $routine')).toList(),
                      ),
                    ),
                  );
                }).toList(),
